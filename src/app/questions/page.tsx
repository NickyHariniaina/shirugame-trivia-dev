...
const Page = () => {
    ...
    const onSubmitQuestion = async (data: QuestionForm) => {
      ...
      try {
        setLoading(true);
        toast.success("Question sent to the admin!, check your notifications for updates!");
        reset();
    ...
    return <div className="flex flex-col gap-4 m-4 p-3 justify-center items-center">
        ...
        <Button variant="outline" onClick={handleGoSubmitButton}>Go submit your own question</Button>
        {showSubmitQuestion && (
          <form
          ...
          >
            ...
            <Textarea
              ...
              {...register("answer", { required: true, minLength: 2 })}
            />
            ...
            <Button type="button" variant="ghost" onClick={handleGoSubmitButton}>
              Cancel
            </Button>
          </form>
        )}
